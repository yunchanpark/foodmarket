...
-- 회원
--INSERT INTO member VALUES(1, now(), now(), "충북 청주시 청원구 내수읍 마산길 72", "진흥아파트 103동 507호", "tkdgh821@naver.com",'kdnews77', "김상호", "010-8923-7325", "$2a$10$pG2Q3DrIIdJlmhdsOEAq5OcwTseGRqszChN9nJli//S4JI8SDFbHu","", "ROLE_MEMBER", 0);
--INSERT INTO member VALUES(2, now(), now(), "충북 청주시 청원구 내수읍 마산길 72", "진흥아파트 103동 507호", "qkrdbscks@naver.com",'yongp99', "박윤찬",  "010-4024-3752", "$2a$10$pG2Q3DrIIdJlmhdsOEAq5OcwTseGRqszChN9nJli//S4JI8SDFbHu","", "ROLE_MEMBER", 0);
--INSERT INTO member VALUES(1, now(), now(), ".", ".", ".",'admin', "관리자",  ".", "$2a$10$pG2Q3DrIIdJlmhdsOEAq5OcwTseGRqszChN9nJli//S4JI8SDFbHu",".", "ROLE_ADMIN", 0);
